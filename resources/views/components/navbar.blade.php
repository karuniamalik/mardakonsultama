<nav class="flex flex-wrap items-center justify-between bg-white p-[20px_30px] rounded-[20px] gap-y-3">
    <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
            <p id="CompanyName" class="font-extrabold text-xl leading-[30px]">Marda Konsultama</p>
            <p id="CompanyTagline" class="text-sm text-cp-light-grey">Build Futuristic Dreams</p>
        </div>
    </div>
    <ul class="flex flex-wrap items-center gap-[30px]">
        <li
            class="font-semibold hover:text-cp-dark-blue transition-all duration-300 {{ request()->routeIs('front.index') ? 'text-cp-dark-blue' : '' }}">
        ...
        <li
            class="font-semibold hover:text-cp-dark-blue transition-all duration-300 {{ request()->routeIs('front.team') ? 'text-cp-dark-blue' : '' }}">
        ...
        <li
            class="font-semibold hover:text-cp-dark-blue transition-all duration-300 {{ request()->routeIs('front.about') ? 'text-cp-dark-blue' : '' }}">
