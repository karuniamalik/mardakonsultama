    ...
    <div id="Contact"
        ...
        <form action="{{ route('front.appointment_store') }}"
            ...
            <div class="flex items-center gap-[18px]">
                ...
                <div class="flex flex-col gap-4 flex w-full">
            ...
            <div class="flex flex-col gap-2 flex w-full">
                ...
                <div
                    ...
                    <textarea name="brief" id="" rows="6"
                        ...
                        placeholder="Ceritakan kepada kami ringkasan pesannya."></textarea>
                </div>
            </div>
            <button type="submit"
                class="bg-cp-dark-blue p-5 w-full rounded-xl hover:shadow-[0_12px_30px_0_#312ECB66] transition-all duration-300 font-bold text-white">Kirim
                Pesan</button>
            <a href="https://wa.me/6285388910812?text=Halo%2C%20saya%20ingin%20menyampaikan%20pesan" class="btn-whatsapp"
                target="_blank">
