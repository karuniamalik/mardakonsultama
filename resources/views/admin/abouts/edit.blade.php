            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.abouts.update', $about) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" value="{{ $about->name }}" class="block mt-1 w-full" type="text"
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @for ($i = 0; $i < 3; $i++)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border"
                                    placeholder="Write your keypoint" name="keypoint[]" {{-- PERHATIKAN BAGIAN VALUE DI BAWAH INI --}}
                                    value="{{ isset($about->keypoints[$i]) ? $about->keypoints[$i]->keypoint : '' }}">
                            @endfor
