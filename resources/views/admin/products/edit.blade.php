            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" value="{{ $product->name }}" class="block mt-1 w-full"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tagline" value="{{ $product->tagline }}" class="block mt-1 w-full"
                            type="text" name="tagline" required autofocus autocomplete="tagline" />
