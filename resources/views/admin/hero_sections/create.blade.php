        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.hero_sections.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <x-input-label for="subheader" :value="__('subheader')" />
                        <x-text-input id="subheader" class="block mt-1 w-full" type="text" name="subheader"
                            :value="old('subheader')" required autofocus autocomplete="subheader" />
                        <x-input-error :messages="$errors->get('subheader')" class="mt-2" />
                    </div>
