            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.statistics.update', $statistic) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="name" value="{{ $statistic->name }}" class="block mt-1 w-full"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="goal" value="{{ $statistic->goal }}" class="block mt-1 w-full"
                            type="text" name="goal" required autofocus autocomplete="goal" />
