...
Route::post('/appointment_store', [FrontController::class,'appointment_store'])->name('front.appointment_store');
...
//  kelompokkan route
    Route::prefix('admin')->name('admin.')->group(function() {
        ...
        Route::middleware('can:manage keypoints')->group(function () {
            ...
            Route::resource('keypoints', CompanyKeypointController::class);
        });
